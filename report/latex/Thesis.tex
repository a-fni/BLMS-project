...
%         \centering
%         \includegraphics[width=\linewidth]{fMA(1).png}
%     \end{minipage}
%     \hfill
%     \begin{minipage}[t]{0.49\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{zMA(1).png}
%     \end{minipage}
% \end{figure}
...
%     \begin{minipage}[t]{0.49\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{fMA(4).png}
%     \end{minipage}
%     \hfill
%     \begin{minipage}[t]{0.49\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{zMA(4).png}
%     \end{minipage}
% \end{figure}

% Massì dai, lasciamole come erano (in verticale). Intendo ruotate di 90°. Sono già così a parte CPI MA, giusto? okok. Ok perfetto

%%ALRIMENTI LASCIAMOLE IN ORIZZONDALE se è troppo lavoro cercare di metterle in orizzontale. ripristino MA per CPI

%si si sono come prima, ed ho aggiornato tutte le immagini alle nuove prior
\newpage
\subsubsection*{Comparison of MA(1) and MA(4)}
...
\addcontentsline{toc}{subsection}{\textbf{GDP Diagnostic Analisys}}
...
\addcontentsline{toc}{subsection}{\textbf{CPI Diagnostic Analisys}}
\subsection{The \textbf{\textit{AR(9)}} Process: Diagnostic Analysis}
\begin{figure}[H]
    \centering
...
where
\[
\bar{D} = -2 \, \mathbb{E}_{\theta}[\log p(y | \theta)], \quad p_D = \tfrac{1}{2}\,\overline{\mathrm{Var}_\theta\bigl[D(\theta)\bigr]} %\bar{D} - D(\bar{\theta})
\]
