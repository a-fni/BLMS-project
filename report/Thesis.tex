...
\puttitle{
	...
	course=Computer Engineering (T2I), % Study Programme (in Italian)
	ID= \\10751746\\
    \quad  10777415\\
    \quad  10794871\\
    \quad  10640001,
	 % Student ID number (numero di matricola)
	advisor= Prof. Federico Bassetti, % Supervisor name % Co-Supervisor name, remove this line if there is none
