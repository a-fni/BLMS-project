...
output_gdp <- list(
  ...
  DIC_gpd       = compute_dic_marginal(jags_output_VAR$sims.list$loglik_gdp)
)
...
output_infl <- list(
  ...
  DIC_cpi      = compute_dic_marginal(jags_output_VAR$sims.list$loglik_infl)
)
