...
### MA(5) trace and density plots (GDP)
...
### VAR(1) trace and density plots (GDP)
...
create_metric_matrix <- function(df, metric_col) {
  metric_matrix <- matrix(NA, nrow=max_order_ar, ncol=max_order_ma)
...
# DIC
dic_matrix <- create_metric_matrix(metrics_df_GDP, "DIC")
image(1:max_order_ar, 1:max_order_ma, dic_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - DIC",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, dic_matrix, add=TRUE)

# WAIC
waic_matrix <- create_metric_matrix(metrics_df_GDP, "WAIC")
image(1:max_order_ar, 1:max_order_ma, waic_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - WAIC",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, waic_matrix, add=TRUE)

# BIC
bic_matrix <- create_metric_matrix(metrics_df_GDP, "BIC")
image(1:max_order_ar, 1:max_order_ma, bic_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - BIC",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, bic_matrix, add=TRUE)

# MSE
mse_matrix <- create_metric_matrix(metrics_df_GDP, "MSE")
image(1:max_order_ar, 1:max_order_ma, mse_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - MSE",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, mse_matrix, add=TRUE)

# MAE
mae_matrix <- create_metric_matrix(metrics_df_GDP, "MAE")
image(1:max_order_ar, 1:max_order_ma, mae_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - MAE",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, mae_matrix, add=TRUE)

# MAPE
mape_matrix <- create_metric_matrix(metrics_df_GDP, "MAPE")
image(1:max_order_ar, 1:max_order_ma, mape_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - MAPE",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, mape_matrix, add=TRUE)

# SMAPE
smape_matrix <- create_metric_matrix(metrics_df_GDP, "SMAPE")
image(1:max_order_ar, 1:max_order_ma, smape_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - SMAPE",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, smape_matrix, add=TRUE)

# MASE
mase_matrix <- create_metric_matrix(metrics_df_GDP, "MASE")
image(1:max_order_ar, 1:max_order_ma, mase_matrix, 
      xlab="AR order (p)", ylab="MA order (q)", main="ARMA - MASE",
      col=heat.colors(20))
contour(1:max_order_ar, 1:max_order_ma, mase_matrix, add=TRUE)
